using Floozys.Hotel.Application.Bookings;
using Floozys.Hotel.Application.Common;
using Floozys.Hotel.Application.Guests;
using Floozys.Hotel.Application.Rooms;
using Floozys.Hotel.Infrastructure.Persistence;
using Floozys.Hotel.Infrastructure.Repositories;
using Floozys.Hotel.Infrastructure.Security;
using Floozys.Hotel.Infrastructure.Time;
