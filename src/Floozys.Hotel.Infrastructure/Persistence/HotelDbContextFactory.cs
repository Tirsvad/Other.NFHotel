...
public sealed class HotelDbContextFactory : IDesignTimeDbContextFactory<HotelDbContext>
{
    ...
    public const string ConnectionStringEnvironmentVariable = "FLOOZYS_HOTEL_CONNECTION";

    private const string PlaceholderConnectionString =
        "Host=localhost;Port=5432;Database=floozys_hotel;Username=postgres;Password=postgres";
