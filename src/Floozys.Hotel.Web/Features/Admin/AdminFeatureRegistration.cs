using Floozys.Hotel.Web.Features.Admin.Bookings;
using Floozys.Hotel.Web.Features.Admin.Dashboard;
using Floozys.Hotel.Web.Features.Admin.Guests;
using Floozys.Hotel.Web.Features.Admin.Rooms;

namespace Floozys.Hotel.Web.Features.Admin;
