using Floozys.Hotel.Domain.Common;
using Floozys.Hotel.Domain.Guests;

namespace Floozys.Hotel.Domain.Tests.Guests;
...
public class GuestValidationTests
{
    ...
    private const string ValidEmail = "valdemar@floozys.dk";
    ...
    /// </summary>
    [Theory]
    [InlineData("valdemar@floozys.dk", true)]
    [InlineData("a@b.c", true)]
    [InlineData(".@", true)] // absurd, men opfylder reglen præcis som den er formuleret
    [InlineData("valdemar.floozys.dk", false)] // intet '@'
    [InlineData("valdemar@floozysdk", false)] // intet '.'
    ...
    [Theory]
    [InlineData("valdemar.floozys.dk")]
    [InlineData("valdemar@floozysdk")]
